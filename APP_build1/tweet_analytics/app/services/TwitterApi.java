...
public class TwitterApi {
	 ...
	 *             account information
	 */
	public ArrayList<Tweet> getTweets(String searchKey) {
		try {
	 ...
	 *             account information
	 */
	public ArrayList<Tweet> convertToTweets(List<Status> tweets)throws Exception {
			...
			for (Status tweet : tweets) {
				...
				text=utils.replaceUrlWithHtmlTags(text);
